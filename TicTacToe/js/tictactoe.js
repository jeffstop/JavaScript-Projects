...
let activePlayer = "X";
// This array stores an array of moves. Will be used to determine win conditions
let selectedSquares = [];
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // If the 3 variables we pass are all included in the array, true is returned and the else if condition executes the drawWinLine funciton
...
function audio(audioURL) {
    // Creating a new audio object and pass the path as a parameter
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.stroke();
        // This condition checks if the endpoint has been reached
        if (x1 <= x2 && y1 <= y2) {
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        // This removes the element's backgroudnImage
        square.style.backgroundImage = ''
    }
    // This resets the array so it is empty and can start over
    selectedSquares = [];
}